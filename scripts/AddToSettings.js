...
classes.eyebrow = classes.eyebrow.map(
	classObj=>{
...
function pageClicked(e){
	...
	previouslySelectedDoc = document.querySelector(
		"."+classes.selected+
		"."+classes.item+
		"."+classes.themed
	) || previouslySelectedDoc;
...
function removePage(name){delete pages[name];}
